  ...
  public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
    if (sender instanceof Player) {
      ...
      if (p.hasPermission(Main.getPermissionNotice("Permissions.Everything")) || p
          .hasPermission(Main.getPermissionNotice("Permissions.Chat.Clear"))) {
        int a = 200;
        if (args.length == 0) {
          ...
          new BukkitRunnable() {
            ...
            public void run() {
              ...
              for (Player s : Bukkit.getOnlinePlayers()) {
                s.sendMessage(Main.prefix + Main.getMSG("Messages.System.ChatClear.Player")
          ...
          new BukkitRunnable() {
            ...
            public void run() {
              ...
              for (Player s : Bukkit.getOnlinePlayers()) {
                s.sendMessage(Main.prefix + Main.getMSG("Messages.System.ChatClear.With-Reason")
        ...
        p.sendMessage(Main.getPrefix() + Main.getMSG("Messages.System.No-Permission")
            .replace("%permission%", Main.getPermissionNotice("Permissions.Chat.Clear")));
      }
    } else {
      int a = 200;
      new BukkitRunnable() {
