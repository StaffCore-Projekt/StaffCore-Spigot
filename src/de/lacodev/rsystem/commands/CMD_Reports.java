  ...
  public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
    if (sender instanceof Player) {
      ...
      if (MySQL.isConnected()) {
        if (p.hasPermission(Main.getPermissionNotice("Permissions.Reports.See")) || p
          ...
          if (args.length == 0) {
            ...
            try {
              ...
              if (rs.next()) {
                ...
                p.sendMessage(
                    Main.getPrefix() + Main.getMSG("Messages.Report-System.Reports.No-Open"));
              }
