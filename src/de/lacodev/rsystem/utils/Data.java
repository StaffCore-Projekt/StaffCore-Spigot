...
public class Data {
  ...
  public static ItemStack buildItemStack(Material mat, int size, int sh, String name, String lore1,
      String lore2) {
  ...
  @SuppressWarnings("deprecation")
  public static ItemStack buildItemStackLore(Material mat, int size, int sh, String name,
  ...
  public static ItemStack buildItemStackLore(XMaterial mat, String name, String lore1, String lore2,
      String lore3) {
    ItemStack stack = mat.parseItem();
    ItemMeta meta = stack.getItemMeta();
    ArrayList<String> lore = new ArrayList<>();
