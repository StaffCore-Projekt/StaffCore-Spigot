...
public class BugManager {
    ...
    public static void createBug(BugReport bugReport){
        try{
            PreparedStatement ps = MySQL.getCon().prepareStatement("INSERT INTO ReportSystem_bugs(CREATOR_NAME,CREATOR_UUID,MESSAGE) VALUES ( ? , ? , ? )");
    ...
    public static void deleteBug(BugReport report){
        try{
            PreparedStatement ps = MySQL.getCon().prepareStatement("DELETE FROM `reportsystem_bugs` WHERE `id` = ? ");
