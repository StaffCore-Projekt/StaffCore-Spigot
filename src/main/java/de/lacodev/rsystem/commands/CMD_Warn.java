    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        if (sender instanceof Player) {
            ...
            if (p.hasPermission(Main.getPermissionNotice("Permissions.Everything")) || p
                    .hasPermission(Main.getPermissionNotice("Permissions.Warn.Use"))) {
                        ...
                        if (target != p) {
                            ...
                            new BukkitRunnable() {
                                ...
                                public void run() {
                                    ...
                                    p.sendMessage(
                                            Main.getPrefix() + Main.getMSG("Messages.Warn-System.Warn.Created"));
                                }
                            ...
                            p.sendMessage(
                                    Main.getPrefix() + Main.getMSG("Messages.Warn-System.Warn.Cant-Warn-Self"));
                        }

                    } else {
                        p.sendMessage(
                                Main.getPrefix() + Main.getMSG("Messages.Warn-System.Warn.Target-Offline"));
                    }
                ...
                if (target != null) {
                    ...
                    new BukkitRunnable() {
                        ...
                        public void run() {
                            ...
                            sender
                                    .sendMessage(Main.getPrefix() + Main.getMSG("Messages.Warn-System.Warn.Created"));
                        }
