...
public class ReportOptions {
    ...
    public void createReportReason(String reason, ItemStack itemStack, String senderName)
            throws ReasonAlreadyExistsExeption {
    ...
    public void createReport(String reporter, Player target, String reason)
            throws ReasonNotExistsExeption {
        if (existsReportReason(reason)) {
